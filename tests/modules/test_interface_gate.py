...
def test_algebra_surface_present_and_module_methods_absent():
    ...
    # simple/projective/injective (Task 3) and hom (Task 5) have since LANDED and are
    # intentionally dropped from this list; the remaining names stay guarded until their
    # tasks land.
    for new in ("ext", "global_dimension", "loewy_length", "complexity",
