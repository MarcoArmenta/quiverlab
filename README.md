...
[![Tests](https://img.shields.io/badge/tests-3042_oracle--pinned-brightgreen)](https://marcoarmenta.github.io/quiverlab/verification/)
...
Every shipped feature is unit tested (the suite is 3042 tests over the
...
- **Tilting and constructions (C7).** tilting/cotilting + Bongartz completion,
  ...
  toolkit. Every construction is certified per instance (a dimension identity + a
