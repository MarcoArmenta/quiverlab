...
The suite is **2295 tests** (collected with the `[dev,fast,docs,web,qpa,hpc]` extras,
...
| `deep` | 1243 | one Linux · py3.12 cell, **twice**: numba and pure (`QUIVERLAB_NO_NUMBA=1`) |
